...
* paylaterProfile();
* kycStatus();
* isGojek('<+628xxxxxxxxxx>'); // include +62
* getQrid('+628xxxxxxxxxx'); // include +62
* getBankList(); // get bank code
* isBank('<bankcode: bri/bca/mandiri/btpn>', '<nomor_rekening>');
* transferGopay('<+628xxxxxxxxxx>', 10000, '<pin_gopay>'); // include +62
* transferBank('<bri/bca/mandiri/btpn>', '<nomor_rekening>', 10000, '<pin_gopay>');
* transferBankDetail('<request_id>');
**/
